...
public class RecuperarSenhaEmail implements TemplateEmailConfig {
	private static final Logger log = LoggerFactory.getLogger(RecuperarSenhaEmail.class);
	...
	public RecuperarSenhaEmail(Mail mail, String usuario, String link) {
		super();
	...
	public MimeMessage template() {
		...
		try {
			...
			Template t = freemarkerConfig.getConfiguration().getTemplate("index-recuperar-senha.ftl");
