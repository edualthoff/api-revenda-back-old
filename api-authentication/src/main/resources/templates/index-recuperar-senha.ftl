    ...
    @media only screen and (max-width:480px) {
      ...
      <div style="background:#FFFFFF;background-color:#FFFFFF;Margin:0px auto;max-width:600px;">
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#FFFFFF;background-color:#FFFFFF;width:100%;">
          <tbody>
            <tr>
              <td style="border:0px #000000 solid;direction:ltr;font-size:0px;padding:0px 0px 0px 0px;text-align:center;vertical-align:top;">
                <!--[if mso | IE]>
      ...
      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
            ...
            <tbody><tr>
              <td align="center" style="font-size:0px;padding:20px 20px 20px 20px;word-break:break-word;">
      ...
      <img height="auto" src="${image}" alt="img" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="252">
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.2;text-align:left;color:#000000;">
        <h2 style="text-align: center; line-height: 100%;">Bem vindo ao Revenda Certa, ${usuario}</h2>
      </div>
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.2;text-align:left;color:#000000;">
        <h3 style="text-align: center; line-height: 100%;">Preciso que você click no botao abaixo para ser redirecionado para a pagina de recuperacão de senha.</h3>
      </div>
